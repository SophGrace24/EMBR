...
(For reference, a **holistic atom** is a dictionary of information that is assigned a positive or negative charge. This is the data that EMBR had been interpreting and refining up until this experiment. She finds relationships in messy waves of these atoms. Below is an attached picture displaying what a usual wave would look like, she would process 9 at a time, coming from different locations at different intervals) 
...
|:------------------:|:----------------------:|
|Security |Alarm system health, security cameras, or Security Locks|
|monitoring seismic data |Geospatial, Athmosphere|
|mapping territory that is human-inaccessible| Testing integrity or search & rescue|
|processing signals into something suitable for analysis| Finding novel patterns in phenomena|
|nondestructive engineering/demolition|monitoring financial trends|
|cybersecurity | Any shift in behavior. Dataleaks, odd employee behaviors, general security concerns|
|astronomy and monitoring events in space| monitoring machine health|
|Household appliances to Generators, Airplanes, medical devices| archealogical research |
|Comparing artifacts to find patterns or differences| physics |
|sentimental analysis | biological research |
|genetics, genomes, expected patterns of behavior all apply|pharmaceutal testing in medication engineering |
|finding stable bonds| monitoring weather trends|
|air pressure, potential use on other planets| personalized health reports for patients with chronic illness|
|heart monitors, brain scans, blood test results, insulin levels| and so much more. |
